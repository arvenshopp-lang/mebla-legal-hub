...
const bytes = await renderBillingPdf(
  {
    ...
    tables: [], totals: [], sections: [{ heading: "البند الأول: نطاق الأعمال", body: "يتولى الطرف الأول تمثيل الطرف الثاني أمام المحاكم المختصة في مدينة الرياض وفق الأنظمة السعودية." }],
