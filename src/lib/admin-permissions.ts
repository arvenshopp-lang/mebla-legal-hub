...
export const ADMIN_PERMISSIONS: PermissionDef[] = [
  ...
  { id: "settings.manage", label: "إعدادات المنصة (موروثة)", group: "موروث", description: "صلاحية واسعة سابقة — تُترجم تلقائياً إلى الصلاحيات الدقيقة. لا تُمنح للأدوار الجديدة." },
  { id: "platform_settings.read", label: "مشاهدة إعدادات المنصة", group: "إعدادات المنصة", description: "الاطلاع على الهوية والبيانات الرسمية والروابط النظامية." },
  { id: "platform_settings.manage", label: "تعديل إعدادات المنصة", group: "إعدادات المنصة", description: "تعديل الهوية والبيانات الرسمية والروابط النظامية." },
  { id: "feature_flags.read", label: "مشاهدة مفاتيح التشغيل", group: "مفاتيح التشغيل والإشعارات", description: "الاطلاع على مفاتيح الميزات وحالتها ونطاقها." },
  { id: "feature_flags.manage", label: "إدارة مفاتيح التشغيل", group: "مفاتيح التشغيل والإشعارات", description: "إنشاء وتعديل وتفعيل وتعطيل مفاتيح الميزات." },
  { id: "notification_rules.read", label: "مشاهدة قواعد الإشعارات", group: "مفاتيح التشغيل والإشعارات", description: "الاطلاع على قواعد الإشعارات وقنواتها." },
  { id: "notification_rules.manage", label: "إدارة قواعد الإشعارات", group: "مفاتيح التشغيل والإشعارات", description: "إنشاء وتعديل قواعد الإشعارات وقنواتها." },
  { id: "integrations.read", label: "مشاهدة التكاملات", group: "التكاملات", description: "الاطلاع على التكاملات وحالتها دون أي تعديل أو كشف مفاتيح." },
  { id: "integrations.manage", label: "إدارة التكاملات ومفاتيحها", group: "التكاملات", description: "تهيئة التكاملات وحفظ أسرارها وحذفها." },
  { id: "integrations.test", label: "اختبار التكاملات", group: "التكاملات", description: "تنفيذ اختبار اتصال للتكامل دون تغيير تهيئته." },
  { id: "integrations.activate", label: "تفعيل وتعطيل التكاملات", group: "التكاملات", description: "تفعيل التكامل أو تعطيله في بيئة التشغيل." },
  { id: "integrations.view_logs", label: "سجلات صحة التكاملات", group: "التكاملات", description: "الاطلاع على سجل فحوص الصحة والأخطاء المنقّحة." },
  { id: "content.read", label: "مشاهدة المحتوى", group: "المحتوى والتصميم", description: "الاطلاع على الصفحات النظامية ومسوّداتها." },
  { id: "content.manage", label: "تحرير المحتوى", group: "المحتوى والتصميم", description: "إنشاء وتعديل مسوّدات الصفحات النظامية." },
  { id: "content.publish", label: "نشر المحتوى", group: "المحتوى والتصميم", description: "نشر مسوّدة الصفحة لتصبح النسخة العامة." },
  { id: "content.rollback", label: "التراجع عن النشر", group: "المحتوى والتصميم", description: "استرجاع نسخة منشورة سابقة للصفحة." },
  { id: "design.read", label: "مشاهدة تصميم المنصة", group: "المحتوى والتصميم", description: "الاطلاع على سمات التصميم ومسوّداتها ونسخها." },
  { id: "design.manage", label: "إدارة تصميم المنصة", group: "المحتوى والتصميم", description: "تعديل السمات والمسوّدات ونشرها والتراجع عنها." },
  { id: "seo.read", label: "مشاهدة إعدادات SEO", group: "المحتوى والتصميم", description: "الاطلاع على الوسوم والفهرسة وملفات robots وsitemap." },
  { id: "seo.manage", label: "إدارة SEO", group: "المحتوى والتصميم", description: "الوسوم والفهرسة وملفات robots وsitemap." },
  { id: "sms.read", label: "مشاهدة إعدادات الرسائل", group: "الرسائل النصية", description: "الاطلاع على تهيئة الرسائل ومزوّديها وسجل التسليم." },
  { id: "sms.manage", label: "إدارة الرسائل النصية", group: "الرسائل النصية", description: "تهيئة مزوّدي الرسائل وقوالبها واختبار الإرسال." },
  { id: "security.read", label: "مشاهدة مركز الأمان", group: "الأمان", description: "الاطلاع على مؤشرات الأمان ومفاتيح التشفير وسجلات الكشف والرفض." },
  { id: "security.manage", label: "إدارة مفاتيح التشفير", group: "الأمان", description: "تسجيل نسخة مفتاح جديدة وتقاعد نسخة وتشغيل دفعات إعادة التشفير." },
  { id: "security.sessions.manage", label: "إدارة جلسات الأمان", group: "الأمان", description: "إبطال جلسات الأجهزة وإدارة قيود الوصول الأمنية." },
  { id: "security.events.export", label: "تصدير أحداث الأمان", group: "الأمان", description: "تصدير سجلات الكشف والرفض الأمنية بصيغة CSV." },
  { id: "monitoring.read", label: "مراقبة النظام", group: "التشغيل", description: "حالة القاعدة والتخزين والبريد والنطاق." },
  { id: "monitoring.export", label: "تصدير تقارير المراقبة", group: "التشغيل", description: "تصدير مؤشرات الخدمات والمهام والأعطال." },
  { id: "backups.read", label: "مشاهدة النسخ الاحتياطية", group: "التشغيل", description: "الاطلاع على سجل النسخ وطلبات الاستعادة دون تعديل." },
  { id: "backups.manage", label: "النسخ الاحتياطي", group: "التشغيل", description: "الاطلاع على حالة النسخ وتصدير البيانات وتسجيل الطلبات." },
