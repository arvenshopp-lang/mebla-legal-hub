...
export const PROCESSING_ERRORS: Record<string, string> = {
  ...
  FILE_MISSING: "الملف غير موجود في مساحة التخزين. يرجى إعادة رفعه.",
  ACCESS_LINK_EXPIRED: "انتهت صلاحية رابط المعالجة المؤقت. أعد المحاولة.",
  INVALID_DOWNLOAD: "استُرجع محتوى غير صالح من مساحة التخزين.",
