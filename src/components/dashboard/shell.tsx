...
const NAV: { to: string; label: string; Icon: typeof LayoutDashboard }[] = [
  ...
  { to: "/dashboard/cases", label: "القضايا", Icon: Briefcase },
  { to: "/dashboard/hearings", label: "الجلسات", Icon: Gavel },
  { to: "/dashboard/deadlines", label: "المهل", Icon: Clock },
  { to: "/dashboard/tasks", label: "المهام", Icon: ListChecks },
  ...
  return (
    <div className="min-h-screen bg-[#F5F3EE] text-[#123C32]" dir="rtl">
      <aside className="fixed inset-y-0 right-0 z-30 hidden w-64 flex-col border-l border-[#123C32]/10 bg-white lg:flex">
        <div className="border-b border-[#123C32]/10 px-5 py-5">
