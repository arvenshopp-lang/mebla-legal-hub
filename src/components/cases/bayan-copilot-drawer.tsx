        ...
        if (res.ok) {
          ...
          if (mounted) {
            ...
            if (data.messages && data.messages.length > 0) {
              ...
              // رسالة ترحيبية أولية من بيان
              setMessages([
                {
                  sender: "assistant",
                  content: `أهلاً بك زميلي الكريم. أنا **المحامية بيان**، مستشارتك القانونية الرقمية في مِهلة.

لقد اطلعت على كامل ملف قضية **«${caseTitle}»** بما في ذلك الأطراف، الجلسات، والمستندات المستخرجة.

يمكنك سؤالي عن أي استشارة، أو طلب صياغة وتفنيد الدفوع، أو احتساب المهل النظامية، وسأجيبك فوراً بالاستناد إلى الأنظمة السعودية المحدثة.`,
                },
              ]);
            }
          }
