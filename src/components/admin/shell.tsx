...
const NAV: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/mehla-admin/backups", label: "النسخ الاحتياطية", Icon: DatabaseBackup, permission: "backups.manage" },
      { to: "/mehla-admin/flags", label: "مفاتيح التشغيل", Icon: ToggleLeft, permission: "settings.manage" },
