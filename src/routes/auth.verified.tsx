    ...
    <div className="min-h-screen bg-[#F5F3EE] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <div className="rounded-3xl border border-[#123C32]/10 bg-white p-8 shadow-[0_20px_60px_-20px_rgba(18,60,50,0.15)]">
          ...
          <p className="mt-2 text-sm leading-7 text-[#123C32]/65">
            حسابك جاهز الآن. يمكنك متابعة قضاياك وجلساتك ومهلك النظامية من داخل المنصة.
          </p>
          <Link
            to={target}
            className="mt-7 inline-flex w-full items-center justify-center rounded-xl bg-[#123C32] py-3 text-sm font-semibold text-white transition hover:bg-[#0d2e26] disabled:opacity-60"
            aria-disabled={busy}
          >
            {busy ? "لحظات…" : label}
          </Link>
          <p className="mt-5 text-xs text-[#123C32]/50">
