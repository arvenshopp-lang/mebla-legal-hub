    ...
    <div className="min-h-screen bg-[#F5F3EE] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <div className="rounded-3xl border border-border bg-surface p-8 shadow-[0_20px_60px_-20px_rgba(18,60,50,0.15)]">
          ...
          <Link
            to={target}
            className="mt-7 inline-flex w-full items-center justify-center rounded-xl bg-[#123C32] py-3 text-sm font-semibold text-primary-foreground transition hover:bg-primary-hover disabled:opacity-60"
            aria-disabled={busy}
          >
            {busy ? "لحظات…" : label}
          </Link>
