...
function VerifiedPage() {
  ...
  return (
    <div className="min-h-dvh bg-[#F5F3EE] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        <div className="mb-8 text-2xl font-bold tracking-tight text-[#123C32]">
        ...
        <div className="rounded-[var(--radius-l)] border border-border bg-surface p-8 shadow-[0_20px_60px_-20px_rgba(18,60,50,0.15)]">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#123C32]">
          ...
          <h1 className="mt-6 text-2xl font-bold text-[#123C32]">تم تأكيد بريدك الإلكتروني بنجاح</h1>
          <p className="mt-2 text-sm leading-7 text-muted-foreground">
            حسابك جاهز الآن. يمكنك متابعة قضاياك وجلساتك ومهلك النظامية من داخل المنصة.
          </p>
          <Link
            to={target}
            className="mt-7 inline-flex w-full items-center justify-center rounded-[var(--radius-m)] bg-[#123C32] py-3 text-sm font-semibold text-primary-foreground transition hover:bg-primary-hover disabled:opacity-60"
            aria-disabled={busy}
          >
            {busy ? "لحظات…" : label}
          </Link>
